...
To solve this issue, I introduced observables into my library, [Finch GraphQL](https://github.com/jcblw/finch-graphql), and updated my React component to listen to the observables using the `useSyncExternalStore` hook. This allowed me to synchronize my component's local state with the external store and avoid the double useEffect calls.
